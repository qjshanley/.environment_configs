...
alias moopid='moopid'
function moodid { echo "rs.slaveOk(); db.currentOp(true).inprog.forEach(function(operation) { msg = \"OPID: \" + operation[\"opid\"] + \" - MILLIS: \"; if(\"secs_running\" in operation) { msg += operation[\"secs_running\"] }; print(msg); } )" | mongo $1 $2; }
